...
def generate_launch_description():
    ...
    move_to_ready_cmd = ExecuteProcess(
        cmd=[
            ...
            "{trajectory: {joint_names: [shoulder_pitch_joint, shoulder_roll_joint, shoulder_yaw_joint, elbow_pitch_joint, elbow_yaw_joint, wrist_roll_joint], points: [{positions: [0.8, 0.8, 0.3, -0.8, 0.3, 0.0], time_from_start: {sec: 2, nanosec: 0}}]}}",
        ],
        output="screen",
    )
